...
/* Question-to-question galaxy zoom transition (a shorter, lighter
   ...
   student moves to a new question). NOTE: QUESTION_TRANSITION_MS
   must match the 380ms duration set on .question-content in
   style.css — keep both in sync if you change this. */
...
const QUESTION_TRANSITION_MS   = 380;  // how long the question content takes to zoom out/in
...
function playGalaxyZoomTransition(exitEl, enterEl, onSwap) {
  ...
  // 1) Current content zooms out and fades, like drifting into space.
